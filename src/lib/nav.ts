...
export const NAV = [
  ...
  { href: "/activity", label: "Activity", icon: Activity, group: "Automation", sub: "Your data & tools" },
  { href: "/developers", label: "Developers · API", icon: Code2, group: "Automation", sub: "Build on Cortex" },
  { href: "/autopilot", label: "AI Autopilot", icon: Bot, group: "Automation", sub: "Automate" },
  { href: "/billing", label: "Billing & Plan", icon: CreditCard, group: "Automation", sub: "Account & billing" },
  { href: "/usage", label: "Usage & Credits", icon: Fuel, group: "Automation", sub: "Account & billing" },
  { href: "/referrals", label: "Refer & Earn", icon: Gift, group: "Automation", sub: "Account & billing" },
  { href: "/admin", label: "Admin & Access", icon: Shield, group: "Automation", sub: "Account & billing" },
