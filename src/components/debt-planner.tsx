            ...
            <tbody>
              {debts.map((d) => (
                <tr key={d.id} className="border-b last:border-0">
                  ...
                  <td className="py-1.5"><button onClick={() => del(d.id)} className="text-muted-foreground hover:text-danger min-h-11 min-w-11 p-2" aria-label="Remove"><Trash2 aria-hidden="true" className="h-3.5 w-3.5" /></button></td>
                </tr>
              ))}
            </tbody>
          </table>
