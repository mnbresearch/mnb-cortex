...
const MOATS = [
  ...
  { n: "2", name: "One brain, not 128 point tools", claim: "Finance, sales, ops and 438 agents draw on the same memory and live data. You can bolt a chatbot onto a dashboard — you can’t retrofit a unified operating brain." },
  ...
  { n: "4", name: "Vertical depth × the AI‑search era", claim: "Industry packs for 27 Indian industries, plus AI Visibility so buyers' assistants surface you. Generalists can’t match the depth; latecomers can’t catch the head start." },
];
      ...
      <section className="px-5 lg:px-10 py-16 border-t">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-px bg-border border rounded-2xl overflow-hidden">
          ...
          <div className="bg-card p-7 lg:p-9">
            ...
            <p className="mt-4 text-muted-foreground leading-7">128 modules, 438 AI agents, with industry packs for 27 Indian industries — all grounded in <span className="text-foreground font-medium">Cortex Memory</span>. Reads bank statements &amp; GST returns; drafts &amp; sends reminders / POs / plans on approval; a weekly plan; and AI Visibility so buyers’ AI assistants recommend you.</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-5 lg:px-10 pb-16">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-px bg-border border rounded-2xl overflow-hidden">
          ...
          <div className="bg-card p-7 lg:p-9">
            ...
            <p className="mt-4 text-muted-foreground leading-7">Self‑serve SaaS. Plans ₹799 → ₹39,999/mo (+ Enterprise). Live payments via Cashfree. Credit‑metered AI with per‑plan allowances and pay‑as‑you‑go packs from ₹149; white‑label &amp; multi‑brand tiers for agencies and groups. No free trial — a free Business Health Check is the top of funnel.</p>
          </div>
        </div>
      </section>
