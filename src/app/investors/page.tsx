...
const MOATS = [
  ...
  { n: "2", name: "One brain, not 130 point tools", claim: "Finance, sales, ops and 438 agents draw on the same memory and live data. You can bolt a chatbot onto a dashboard — you can’t retrofit a unified operating brain." },
      ...
      <section className="px-5 lg:px-10 py-16 border-t">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-px bg-border border rounded-2xl overflow-hidden">
          ...
          <div className="bg-card p-7 lg:p-9">
            ...
            <p className="mt-4 text-muted-foreground leading-7">130 modules, 438 AI agents, with industry packs for 27 Indian industries — all grounded in <span className="text-foreground font-medium">Cortex Memory</span>. Reads bank statements &amp; GST returns; drafts &amp; sends reminders / POs / plans on approval; a weekly plan; and AI Visibility so buyers’ AI assistants recommend you.</p>
          </div>
        </div>
      </section>
