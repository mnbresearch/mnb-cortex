...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = ["", "/features", "/industries", "/compare", "/resources", "/ai-visibility", "/health-check", "/pricing", "/investors", "/status", "/changelog", "/help", "/terms", "/privacy", "/refund", "/contact", "/login", "/dashboard"];
