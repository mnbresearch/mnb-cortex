...
export default async function Setup() {
  ...
  const rows: Row[] = [
    ...
    { name: "Auto-renewal (Cashfree mandates)", on: hasCashfree(), env: "CASHFREE_APP_ID + CASHFREE_SECRET_KEY",
      what: "UPI Autopay / card / eNACH mandates so plans renew without the customer re-paying.",
      how: "Same Cashfree keys. Ask Cashfree to enable Subscriptions on your account. UPI Autopay caps at ₹15,000/mandate — Premium and Business need card or eNACH." },
