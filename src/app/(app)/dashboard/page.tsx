...
import { getMetrics, getInsights, getAlerts, getFinanceSeries } from "@/lib/data";
...
export default async function Dashboard() {
  ...
  const chartData = fin.live && fin.series ? fin.series : demoRevenueSeries;
  ...
  return (
    <>
      ...
      <PageShell>
        ...
        <Card className="p-5"><CortexScore metrics={metrics} /></Card>
