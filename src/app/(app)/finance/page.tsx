...
import { getInsights, getInvoices } from "@/lib/data";
    ...
    <>
      ...
      <PageShell>
        ...
        <Section title="Revenue vs net profit" desc="Trailing 12 months (₹ Cr)">
          <TrendChart data={pl} keys={[{ k: "revenue", label: "Revenue", color: "hsl(var(--primary))" }, { k: "profit", label: "Net profit", color: "hsl(var(--success))" }]} />
        </Section>
