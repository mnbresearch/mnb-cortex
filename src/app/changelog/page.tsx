...
const releases = [
  { v: "4.1.0", date: "Latest", items: ["Teach Cortex — one click ingests your customers, team, KPIs & insights into memory", "\"Remember this\" on any AI CEO chat answer — save it to long-term memory", "Auto-builds the entity graph from your real business data"] },
