...
const releases = [
  { v: "3.0.0", date: "Latest", items: ["Financial ratios analyzer (liquidity, leverage, returns)", "Depreciation schedule (SLM & WDV)", "Income tax estimator — new vs old regime", "GST calculator (add/remove + CGST/SGST/IGST)", "Multi-currency converter", "80+ modules · milestone release"] },
