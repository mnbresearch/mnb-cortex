...
const releases = [
  { v: "2.6.0", date: "Latest", items: ["Integration marketplace expanded to 60+ tools", "Odoo, Cashfree, PayU, MSG91, Gupshup, Freshdesk, Intercom, Calendly & more", "\"Custom API key\" — store a key for any tool, encrypted", "Live connection tests for SendGrid, Brevo, Calendly, Intercom", "Higher integration limits per plan"] },
