...
const releases = [
  { v: "4.2.0", date: "Latest", items: ["Export your entire memory (JSON + Markdown) — your data, always portable", "Cash Conversion Cycle — DIO + DSO − DPO with cash-locked estimate", "Net Worth & Balance Sheet builder", "100+ modules"] },
