...
const releases = [
  { v: "2.8.0", date: "Latest", items: ["Real 14-day free trial — enforced, not cosmetic", "Countdown banner + hard paywall when the trial ends", "Payment activates the subscription and lifts the paywall", "Refer & Earn program with shareable links", "Futuristic landing page with all features listed"] },
