...
const releases = [
  { v: "4.0.0", date: "Latest", items: ["Cortex Memory — a permanent, evolving memory for your AI COO", "Every AI action (chat, reports, forecasts, strategy) is now grounded in what Cortex remembers", "Capture facts, decisions & preferences; extract memories from any pasted text", "Knowledge graph of people, customers, vendors & products", "A living, auto-synthesized company profile", "Pin, supersede and cluster memories into themes — the memory layer, built in"] },
