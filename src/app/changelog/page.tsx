...
const releases = [
  { v: "4.3.0", date: "Latest", items: ["Appraisal & Hike Planner — distribute a raise budget across bands", "GST Late Fee & Interest calculator", "Marketing Budget & ROAS allocator across channels", "Landing page refreshed — 100+ modules, Cortex Memory front-and-centre"] },
