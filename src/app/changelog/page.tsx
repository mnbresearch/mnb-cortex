...
const releases = [
  { v: "2.9.0", date: "Latest", items: ["Customer RFM segmentation with AI actions", "Loan amortization schedule (principal vs interest)", "Sales commission calculator with accelerators", "A/B test significance (two-proportion z-test)", "Inventory ABC (Pareto) analysis", "Request-access flow with email notifications"] },
