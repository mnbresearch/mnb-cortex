...
const releases = [
  { v: "1.4.0", date: "Latest", items: ["Investor & Board Update generator", "Marketing Studio — full campaign kits in one click", "Competitor Intelligence battlecards", "Hindi & Hinglish replies in the AI CEO chat", "Email now delivers from your verified domain"] },
