...
const releases = [
  { v: "3.3.0", date: "Latest", items: ["Payables & DPO with an early-payment-discount decision", "Inventory turnover, DIO and annual holding cost", "GST ITC set-off — net cash payable by CGST/SGST/IGST head", "DSCR & loan eligibility estimator", "Billable rate calculator for services businesses", "95+ modules"] },
