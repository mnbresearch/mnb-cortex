...
const releases = [
  { v: "3.1.0", date: "Latest", items: ["Markup ↔ margin converter with keystone & margin quick-sets", "Break-even by product mix (blended contribution margin)", "Investment growth — SIP & lumpsum future value", "Debt payoff planner — avalanche vs snowball", "Printable quotation builder with validity & terms", "85+ modules"] },
