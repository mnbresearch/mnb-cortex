...
const releases = [
  { v: "1.3.0", date: "Latest", items: ["Daily CEO Brief — generated + emailed to your inbox", "Customer Churn Predictor with editable risk model", "Negotiation Coach & Hiring/Org Advisor", "GST & Compliance assistant with filing calendar", "New GST-aware AI reasoning mode"] },
